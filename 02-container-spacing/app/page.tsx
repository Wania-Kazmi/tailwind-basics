...
export default function Home() {
  return (
    <div className="container mx-auto">
      ...
      <div className="bg-slate-200 m-2">Hello Margin</div>
      <div className="bg-slate-200 ml-4">Hello Margin</div>
      <div className="bg-slate-200 mr-4">Hello Margin</div>
      <div className="bg-slate-200 mt-4">Hello Margin</div>
      <div className="bg-slate-200 mb-4">Hello Margin</div>

      {/* arbitrary values */}
      <div className="bg-slate-200 mt-[20px]">Hello Margin</div>


      {/* <!-- Padding --> */}
      <h2 className="font-bold">Padding</h2>
      <div className="bg-slate-200 p-2">Hello Padding</div>
      <div className="bg-slate-200 pl-4">Hello Padding</div>
      <div className="bg-slate-200 pr-4">Hello Padding</div>
      <div className="bg-slate-200 pt-4">Hello Padding</div>
      <div className="bg-slate-200 pb-4">Hello Padding</div>

      {/* arbitrary values */}
      <div className="bg-slate-200 pt-[20px]">Hello Padding</div>

...
export default function Home() {
  return (
    <div>
      ...
      {/* <!-- Transition --> */}
      {/* when we use opacity then use it with transition-opacity or transition or transition-all. transition-colors does not work with it otherwise with transition color it doesnot transition it will be right away */}
      <button className="px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 hover:opacity-20 transition-all duration-1000">
        Click me
      </button>

      {/* <!-- Transition & Transform --> */}
      <button className="px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 hover:rotate-45 transition-transform duration-1000">
        Click me
      </button>
      ...
      <Image
        ...
        height={500}
        width={500}
        className="hover:rotate-180 hover:scale-75 hover:skew-x-12 transition duration-2000"
      />
    </div>
  );
}
